...
#define LAST_ID_CHAINWORK   "0x8b5410"
#define LAST_ID_HEIGHT      31572
...
public:
    CMainParams() {
        ...
        consensus.dwarfGestationBlocks = 8;                 // The number of blocks for a new dwarf to mature
        /////////////////////////////////////////////////////////////////////////////////////        
        ...
        consensus.popMaxPrivateGameDepth = 22;              // Private game source transactions must be at most this many blocks deep
        consensus.popMaxPublicGameDepth = 52;               // Public game source transactions must be at most this many blocks deep
