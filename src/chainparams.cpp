...
#define LAST_ID_BLOCK_HASH  "0xad888c212342a83b753c94e7d7f001ebbe14698d7e43ddae8a1447d287d26574"
#define LAST_ID_CHAINWORK   "0x8b7c10"
#define LAST_ID_HEIGHT      31612
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 120; // Targeting 3 blocks every 120 seconds
        ...
        consensus.minDwarfCost = 10000;                     // Minimum cost of a dwarf, used when no more block rewards
        consensus.dwarfCostFactor = 2500;                   // Dwarf cost is block_reward/dwarfCostFactor
        ...
        consensus.dwarfLifespanBlocks = 1.5*60*24*7;        // The number of blocks a dwarf lives for after maturation (7 days)
        ...
        consensus.popMaxPrivateGameDepth = 1.5*30;          // Private game source transactions must be at most this many blocks deep
        consensus.popMaxPublicGameDepth = consensus.popMaxPrivateGameDepth + 1.5*60*2;             // Public game source transactions must be at most this many blocks deep
