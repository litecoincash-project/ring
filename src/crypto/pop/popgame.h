...
public:
    ...
    virtual bool VerifyGameSolution(int targetScore, uint256 gameSourceHash, std::vector<unsigned char> solution, std::string& strError){ return false; };    // Verify solution given a game source hash and a solution. OVERWRITES ALL INTERNAL STATE.
