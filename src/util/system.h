 ...
 */
#ifndef RING_UTIL_SYSTEM_H
#define RING_UTIL_SYSTEM_H
...
extern const char * const RING_CONF_FILENAME;
...
{
    std::string s = strprintf("ring-%s", name);
