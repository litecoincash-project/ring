...
{
    // Call into TxToUniv() in ring-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in ring-common, so we query them here and push the
...
UniValue createrawdct(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("createrawdct", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\" 1 \"RYQQuhMcsPvw36Hk8CvuXsQjxu14qTVuvS\"")
            + HelpExampleCli("createrawdct", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\" 5 \"RYQQuhMcsPvw36Hk8CvuXsQjxu14qTVuvS\" false")
            + HelpExampleRpc("createrawdct", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\", 12 \"RYQQuhMcsPvw36Hk8CvuXsQjxu14qTVuvS\"")
            + HelpExampleRpc("createrawdct", "\"[{\\\"txid\\\":\\\"myid\\\",\\\"vout\\\":0}]\", 34 \"RYQQuhMcsPvw36Hk8CvuXsQjxu14qTVuvS\" false")
        );
...
static UniValue decoderawtransaction(const JSONRPCRequest& request)
{
    const RPCHelpMan help{"decoderawtransaction",
            ...
            "         \"type\" : \"pubkeyhash\",  (string) The type, eg 'pubkeyhash'\n"
            "         \"addresses\" : [           (json array of string)\n"
            "           \"12tvKAXCxZjSmdNbao16dKXC8tRWfcF5oc\"   (string) ring address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"decodepsbt",
                "\nReturn a JSON object representing the serialized, base64-encoded partially signed Ring transaction.\n",
                {
            ...
            "          \"hex\" : \"hex\",            (string) The hex\n"
            "          \"type\" : \"pubkeyhash\",    (string) The type, eg 'pubkeyhash'\n"
            "          \"address\" : \"address\"     (string) Ring address if there is one\n"
            "        }\n"
            "      },\n"
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed Ring transactions into one transaction.\n"
