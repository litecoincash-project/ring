...
{
    BOOST_CHECK(TestSplitHost("www.ringcoin.tech", "www.ringcoin.tech", -1));
    BOOST_CHECK(TestSplitHost("[www.ringcoin.tech]", "www.ringcoin.tech", -1));
    BOOST_CHECK(TestSplitHost("www.ringcoin.tech:80", "www.ringcoin.tech", 80));
    BOOST_CHECK(TestSplitHost("[www.ringcoin.tech]:80", "www.ringcoin.tech", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:28971", "127.0.0.1", 28971));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:28971", "127.0.0.1", 28971));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:28971", "::ffff:127.0.0.1", 28971));
    BOOST_CHECK(TestSplitHost("[::]:28971", "::", 28971));
    BOOST_CHECK(TestSplitHost("::28971", "::28971", -1));
    BOOST_CHECK(TestSplitHost(":28971", "", 28971));
    BOOST_CHECK(TestSplitHost("[]:28971", "", 28971));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:28971", "127.0.0.1:28971"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:28971", "[::]:28971"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
