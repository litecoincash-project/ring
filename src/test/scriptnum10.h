...
#ifndef RING_TEST_SCRIPTNUM10_H
#define RING_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ring Core 0.10.0, for cross-comparison.
 */
public:
