...
#ifndef RING_WALLET_WALLET_H
#define RING_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! ring from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this ring node, and set to 0 for transactions that were created
