...
QString RingUnits::longName(int unit)
{
    ...
    case uRNG: return QString::fromUtf8("µRNG (bits)");
...
QString RingUnits::shortName(int unit)
{
    switch(unit)
    {
    case uRNG: return QString::fromUtf8("bits");
...
QString RingUnits::description(int unit)
{
    ...
    case uRNG: return QString("Micro-Rings (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
