...
#include <config/ring-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatRingURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + RingUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatRingURI(info));
}
