...
#ifndef RING_QT_RINGUNITS_H
#define RING_QT_RINGUNITS_H
...
/** Ring unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RingUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RingUnits(QObject *parent);

    /** Ring units.
      @note Source: https://en.ring.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        RNG,
...
typedef RingUnits::Unit RingUnit;

#endif // RING_QT_RINGUNITS_H
