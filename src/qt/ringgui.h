...
#ifndef RING_QT_RINGGUI_H
#define RING_QT_RINGGUI_H
...
/**
  Ring GUI main class. This class represents the main window of the Ring UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class RingGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit RingGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~RingGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a ring wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    // Ring-fork: Skinning: Apply pretty styles
    void skinIt();
