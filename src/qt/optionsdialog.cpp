    ...
    mapper(nullptr)
{
    ...
    ui->ringAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ringAtStartup);
    ...
    ui->ringAtStartup->setToolTip(ui->ringAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->ringAtStartup->setText(ui->ringAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openRingConfButton->setToolTip(ui->openRingConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new RingUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ringAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openRingConfButton_clicked()
{
