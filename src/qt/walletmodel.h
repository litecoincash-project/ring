...
#ifndef RING_QT_WALLETMODEL_H
#define RING_QT_WALLETMODEL_H
...
/** Interface to Ring wallet from Qt view code. */
...
public:
    ...
    int getCurrentScoreTarget();                                                                                                        // Ring-fork: Pop
