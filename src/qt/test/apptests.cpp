...
//! Entry point for RingApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &RingApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for RingGUI tests.
void AppTests::guiTests(RingGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &RingGUI::consoleShown, this, &AppTests::consoleTests);
