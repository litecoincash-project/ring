    ...
    platformStyle(_platformStyle)
{
    ...
    // normal ring address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying ring address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &RingAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
