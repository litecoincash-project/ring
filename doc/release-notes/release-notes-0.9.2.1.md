Ring Core version 0.9.2.1 is now available from:

  https://ring.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 RNG to 0.01 RNG
...
- Fix "Start ring on system login"
