Ring version 0.6.2 is now available for download at:
http://sourceforge.net/projects/ring/files/Ring/ring-0.6.2/
...
Fixed https://github.com/litecoincash-project/ring/issues/1065, a bug that
