Download URL: https://sourceforge.net/projects/ring/files/Ring/ring-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 RNG fee schedule (users still pay 0.01 RNG per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #ring00 - #ring99
