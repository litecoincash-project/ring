Ring-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ring/files/Ring/ring-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ring
...
New/changed settings (command-line or ring.conf file)
--------------------------------------------------------
