Ring Core version 0.13.2 is now available from:

  <https://ring.org/bin/ring-core-0.13.2/>
...
- #8908 `4a974b2` Update ring-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ring-tx to create v2 transactions (rngdrak)
