Ring Core version 0.9.4 is now available from:

  https://ring.org/bin/0.9.4/
...
this update is incompatible with the Ring system and could lead to consensus
forks.

Ring Core released binaries from https://ring.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ring/+archive/ubuntu/ring
- A third-party or self-compiled Ring Core

upgrade to Ring Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
