...
Download:
http://sourceforge.net/projects/ring/files/Ring/ring-0.3.13/
...
http://www.ring.org/download/ring-0.3.13.1-specialbuild-linux64.tar.gz
...
http://www.ring.org/download/ring-0.3.13.2-win32-setup.exe
