Ring version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ring/files/Ring/ring-0.5.4/
...
http://gitorious.org/ring/ringd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Ring-Qt notifications under Growl 1.3.
Increase required age of Ring-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRing properly when installing Ring-Qt over it. (Windows)
