Ring Core version 0.16.1 is now available from:

  <https://ringcore.org/bin/ring-core-0.16.1/>
...
- #12843 `df38b13` Test starting ringd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure ringd processes are cleaned up when tests end (sdaftuar)
