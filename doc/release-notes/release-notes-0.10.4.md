Ring Core version 0.10.4 is now available from:

  <https://ring.org/bin/ring-core-0.10.4/>
...
- #6953 `43c2789` Split ring-tx into its own package
- #6953 `dfe0d4d` Include ring-tx binary on Debian/Ubuntu
