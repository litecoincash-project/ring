...
ring.conf        | contains configuration settings for ringd or ring-qt
ringd.pid        | stores the process id of ringd while running
...
debug.log           | contains debug information and general logging generated by ringd or ring-qt
