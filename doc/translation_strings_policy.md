...
This document provides guidelines for internationalization of the Ring Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ring_en.ts` remains unchanged.
