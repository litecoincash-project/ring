...
// ring includes.
#include <..\src\script\ringconsensus.h>
...
int main()
{
    std::cout << "ringconsensus version: " << ringconsensus_version() << std::endl;
    ...
    auto op0Result = ringconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, ringconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
