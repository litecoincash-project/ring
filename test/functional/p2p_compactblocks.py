...
# TestP2PConn: A peer we use to send messages to ringd, and store responses.
...
class CompactBlocksTest(RingTestFramework):
    ...
    # This test actually causes ringd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ringd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ringd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ringd will not send blocktxn responses for blocks whose height is
