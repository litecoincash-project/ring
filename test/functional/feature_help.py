...
"""Verify that starting ring with -h works as expected."""

from test_framework.test_framework import RingTestFramework
from test_framework.util import assert_equal

class HelpTest(RingTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ring with -h for help text")
        ...
        self.log.info("Start ring with -version for version information")
        ...
        self.log.info("Start ringd with -fakearg to make sure it does not start")
