...
class ConfArgsTest(RingTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'ring.conf'), 'a', encoding='utf-8') as conf:
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "ring.conf")
        ...
        # Temporarily disabled, because this test would access the user's home dir (~/.ring)
